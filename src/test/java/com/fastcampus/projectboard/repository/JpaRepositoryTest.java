...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newAjs", "pw", null, null, null));
    ...
    @DisplayName("댓글 삭제와 대댓글 전체 연동 삭제 리스트")
    @Test
    ...
    void givenArticleCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        // When
        articleCommentRepository.deleteByIdAndUserAccount_UserId(1L, "ajs9303");
