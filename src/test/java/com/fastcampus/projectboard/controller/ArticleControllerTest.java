...
class ArticleControllerTest {
    ...
    @Test
    void givenPagingAndSortingParams_thenSearchingArticlesPage_thenReturnArticlesView() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "ajsTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
